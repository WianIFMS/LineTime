<?php
        ...
        $images   = array("<img style=\"width: 20px;\" src=\"../imagens/emoticons/angry.png\" class=\"emoticons-size\" title=\":angry:\">", 
            ...
            $sql = "SELECT id, id_de, id_para, id_grupo, mensagem,dt_mensagem FROM mensagens WHERE id_grupo = ? ORDER BY id DESC";
            ...
            if(count($linha) <= 0){
        	   ...
        	   if($row['id_de'] == $id_de) {?>
            	<!--<div align="right"><p class="chat-i"><?php echo $linha2["nome"].": ".$row['mensagem'];?></p></div>-->
                                    ...
                                    <div class="balao-campoMensagens"><span class="badge badge-primary email-item-unread-4"><div class="hora-campoMensagem" style="float: left;"><?php echo $linha2["nome"];?> :</div> </br><?php echo $row['mensagem'];?> </br><div class="hora-campoMensagem"><?php echo $hora[1];?></div></span></div>
