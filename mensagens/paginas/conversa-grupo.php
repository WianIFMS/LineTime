<?php
    ...
    if(isset($_POST['env']) && $_POST['env'] == "envMsg"){
        ...
        if(empty($mensagem)){
            ...
            $sqlprep->bind_param("ssss", $id_de, $id_grupo, $mensagem, $data);                   //atribui parametros ao sql
            $sqlprep->execute();
            if($sqlprep !=""){
...
<?php 
    ...
    $sqlprep->bind_param("i", $_GET["id_grupo"]);
    $sqlprep->execute(); 
                ...
                <div class="card text-center">
                    <div class="card-header">
                        <div class="usuario-header">
                            ...
                            <?php echo $grupo["nome"];?><font color="#008B45"><i class="fas fa-comments"></i> </font> 
                        </div>
                    </div>
                    <form class="pure-form" method="post" action="">    
                                <input type="text" class="pure-input-rounded input-ecreverMensagem" placeholder="Escrever Mensagem" name="mensagem">
