			...
			<div class="header">
			    ...
			    <div class="home-menu pure-menu pure-menu-horizontal pure-menu-fixed">
			        ...
			        <ul class="pure-menu-list">
			            <li class="pure-menu-item email-item-unread"><a href="../login.php" class="pure-menu-link">Entrar na conta <i class="fas fa-user-circle"></i></a></li>
			            <li class="pure-menu-item email-item-unread-2"><a href="#" class="pure-menu-link">Nova Conta <i class="fas fa-user-plus"></i></a></li>
			        </ul>
			...
			<div class="Corpo">	
					...
					<div class="campo_cadastro">
						<div id="formulario_2">
								...
								<div class="col-md-6">	
									<div class="form-group">
										<div id="email_1">
											...
											<input id="email1" name="email" type="email" class="form-control" id="formGroupExampleInput" placeholder="Digite seu email">
										</div>
									</div>
								</div>	
								<div class="col-md-6">	
							...
							<h5><a href="../login.php" class="btn btn-danger btn-lg btn-block">Entrar na conta</a></h5>
